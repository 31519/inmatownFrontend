...
const BbcComponent = ({ datas, header, link, staticImg="/jobs.jpg", loading=false }) => {
        ...
        datas.slice(0,6).map((data, index) => (
          <Link href={`/${link}/${data.slug}/${data.id}`}>
            ...
            <div className={( index == 0 ? bbcStyle.container0: bbcStyle.container)}>
              ...
              <div className={( index == 0 ? bbcStyle.imageContianer0: bbcStyle.imageContianer)}>
                {data.image ? (
                  <img
              ...
              <div className={(index == 0 ? bbcStyle.textContainer0: bbcStyle.textContainer)}>
