...
export const advertiseListAction = (keyword = '') => async (dispatch) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/advertisement/list${keyword}`
        );
        dispatch({
...
export const allAdvertiseListAction = (keyword = '') => async (dispatch) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/advertisement/alllist`
        );
        dispatch({
...
export const advertiseUserListAction = () => async (dispatch, getState) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/advertisement/user-list/`,
            config
        );
        dispatch({
...
export const advertiseDetailAction = (id, slug) => async (dispatch) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/advertisement/list/${id}/${slug}`
        );
        dispatch({
...
export const localListAction = (keyword="") => async (dispatch, getState) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/localnews/list${keyword}`
        );
        dispatch({
...
export const localDetailAction = (id, slug) => async (dispatch) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/localnews/list/${id}/${slug}`
        );
        dispatch({
...
export const bannerListAction = (keyword="") => async (dispatch, getState) => {
    try{
        ...
        const { data } = await axios.get(
            `${process.env.NEXT_PUBLIC_DEVELOPMENT_URL}/api/meme/banner/list/`
        );
        dispatch({
