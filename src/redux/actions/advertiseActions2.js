...
export const hotelListAction =
  (keyword = "") =>
  async (dispatch) => {
    try {
      dispatch({ type: HOTEL_LIST_REQUEST });
      const { data } = await axios.get(`api/hotels/list${keyword}`);
      dispatch({
...
export const hotelUserListAction = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`api/hotels/user-list/`, config);
    dispatch({
...
export const hotelDetailAction = (id, slug) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`api/hotels/list/${id}/${slug}`);
    dispatch({
...
export const hotelCreateAction = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`api/hotels/create/`, {}, config);
...
export const resellerListAction =
  (keyword = "") =>
  async (dispatch) => {
    try {
      dispatch({ type: RESELLER_LIST_REQUEST });
      const { data } = await axios.get(`api/resell/list${keyword}`);
      dispatch({
...
export const allResellerListAction =
  ...
  async (dispatch) => {
    try {
      dispatch({ type: ALL_RESELLER_LIST_REQUEST });
      const { data } = await axios.get(`api/resell/alllist`);
      dispatch({
        type: ALL_RESELLER_LIST_SUCCESS,
        payload: data,
      });
    } catch (error) {
      dispatch({
        type: ALL_RESELLER_LIST_FAIL,
        payload:
          error.response && error.response.data.detail
            ? error.response.data.detail
            : error.message,
...
export const resellerUserListAction = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`api/resell/user-list/`, config);
    dispatch({
...
export const resellerDetailAction = (id, slug) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`api/resell/list/${id}/${slug}`);
    dispatch({
...
export const resellerCreateAction = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`api/resell/create/`, {}, config);
...
export const resellerUpdateAction =
  (reseller) => async (dispatch, getState) => {
    try {
...
export const resellerDeleteAction =
  (id, slug) => async (dispatch, getState) => {
    try {
...
export const tourismsListAction =
  (keyword = "") =>
  async (dispatch) => {
    try {
      dispatch({ type: TOURISMS_LIST_REQUEST });
      const { data } = await axios.get(`api/tourisms/list${keyword}`);
      dispatch({
...
export const tourismsUserListAction = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`api/tourisms/user-list/`, config);
    dispatch({
...
export const tourismsDetailAction = (id, slug) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`api/tourisms/list/${id}/${slug}`);
    dispatch({
...
export const tourismsCreateAction = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`api/tourisms/create/`, {}, config);
...
export const tourismsUpdateAction =
  (tourisms) => async (dispatch, getState) => {
    try {
...
export const tourismsDeleteAction =
  (id, slug) => async (dispatch, getState) => {
    try {
