      ...
      <div id="content">
        ...
        <Grid spacing={2} className={PrivacyStyle.gridContent} container>
          ...
          <Grid spacing={1} item xs={12} sm={6} lg={6} md={6}>
            ...
            <h2 className={PrivacyStyle.text}>Advertising Partners Privacy Policies</h2>
            ...
            <h2 className={PrivacyStyle.text}>Third Party Privacy Policies</h2>
            ...
            <h2 className={PrivacyStyle.text}>CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
