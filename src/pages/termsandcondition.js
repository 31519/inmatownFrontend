...
function Termsandcondition() {
  return (
    <div className={AboutusStyle.termsDiv}>
      <Head>
        <meta
          name="viewport"
          content="width=device-width, initial-scale=1"
        ></meta>
        <meta name="description" content="CRfeeds - Terms and Conditions"></meta>
      ...
      <p>Welcome to www.crfeeds.in!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of crfeeds's Website, located at https://www.crfeeds.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use www.crfeeds.in if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing www.crfeeds.in, you agreed to
        use cookies in agreement with the crfeeds's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, crfeeds and/or its licensors own the
        intellectual property rights for all material on www.crfeeds.in. All
        intellectual property rights are reserved. You may access this from
        www.crfeeds.in for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from www.crfeeds.in</li>
        <li>Sell, rent or sub-license material from www.crfeeds.in</li>
        <li>Reproduce, duplicate or copy material from www.crfeeds.in</li>
        <li>Redistribute content from www.crfeeds.in</li>
      </ul>
      ...
      <p>
        ...
        crfeeds does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of crfeeds,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, crfeeds shall not be liable for the
      ...
      <p>
        crfeeds reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant crfeeds a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of crfeeds; and (d) the link is in
      ...
      <p>
        ...
        e-mail to crfeeds. Please include your name, your organization name,
      ...
      <p>
        No use of crfeeds's logo or other artwork will be allowed for linking
      ...
      <p>
        ...
        rising on your Website. Cos, [07.10.22 18:59] No link(s) should appear
        on any Website that may be interpreted as libelous, obscene or criminal,
